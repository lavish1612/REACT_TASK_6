      ...
      <div className="main-content">
        {selectedSection === "Home" && (
          <div className="content-section">
            ...
            <p>
              I'm Lavish Yadav, a web developer who's dedicated to crafting
...
monitor and assess the health and performance of electric vehicle (EV) motors in real-time.
            ...
            <div className="content-section">
              <h2>About Me</h2>
              <p>
                Hi, I'm Lavish Yadav, a web developer with expertise in HTML and
            ...
            <div className="content-section">
              ...
              <div className="content-section">
                <h2>Contact Me</h2>
                <p>Name: Lavish Yadav</p>
                <p>Mobile: 8306077257</p>
                <p>Email: ylavish07@gmail.com</p>
                <p>
                  Linkedin:{" "}
      ...
      {selectedSection === "About" && (
        <div className="content-section">
          <h2>About Me</h2>
          <p>
            Hi, I'm Lavish Yadav,  a web developer with expertise in HTML and CSS.
